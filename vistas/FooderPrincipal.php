...
<div class="componente2">
        <div class="bloque1">
            <a href="../index.php"><img src="../icons/LOGO.png" alt=""  width="200" height="200"></a></div>
        <div class="bloque1-1">
            <p class="info-principal">Somos una organizacion que da a promover los locales de todo el centro de cali para una mayor comercializacion.</p>
            <p class="sub-info">Copyright ©2023 Center Shop Cali.</p> 
        </div>
            <div class="bloque2"> 
